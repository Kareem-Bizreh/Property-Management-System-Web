...
const MostRatedServiceProviders = () => {
    const offices = [
        {id: 1, type: 'كهربائي', name: 'كريم البزرة', location: 'دمشق, المزة', rate: 4.75},
        {id: 2, type: 'كهربائي', name: 'ليلى حداد', location: 'دمشق, باب توما', rate: 4.6},
        {id: 3, type: 'كهربائي', name: 'سامر خليل', location: 'دمشق, برزة', rate: 4.8},
        {id: 4, type: 'كهربائي', name: 'رنا يعقوب', location: 'دمشق, الميدان', rate: 4.7},
        {id: 5, type: 'كهربائي', name: 'أنس الزعيم', location: 'دمشق, القابون', rate: 4.5},
    ];
