...
const FinancialRecord = ({
                             record: {
                                 ...
                                 paymentMethod, price, status, invoiceImage
                             }
                         }) => {
    ...
    const onUpload = async () => {
        ...
        setIsLoading(true)
        const {success, response} = await uploadDocument(id, invoice);
        if (success) {
    ...
    return (
        <div
            className="min-h-[85px] w-full h-auto rounded-[25px] flex flex-row flex-wrap justify-between items-center py-4 gap-4"
            style={{
