...
const PaymentMethod = () => {
    ...
    return (
        ...
        >
            ...
            <div className="grid grid-cols-[auto_auto_1fr] grid-rows-1 place-items-center gap-2">
                <Checkbox
                    checked={office?.stripe_payment}
                    onChange={(e) => setOffice({...office, stripe_payment: e.target.checked})}
            ...
            <CreditCard number={office.creditCard ?? ""}/>
        </div>
    )
}
